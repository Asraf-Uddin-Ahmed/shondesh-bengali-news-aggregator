...
public class Home extends javax.swing.JFrame {
    ...
    public Home() {
        ...
        //retrieving password & user name
        FileDirectory fd = new FileDirectory();
        String userName =null ;
        String password = null;    //Password(SQL) will given by user for SQL connention.
        try{
            userName = fd.getFileString("C:\\Shondesh\\info\\user.name");
            password = fd.getFileString("C:\\Shondesh\\info\\mysql.pass");
        }catch(Exception e){
        ...
        String wellcomeMsg = "Wellcome "+userName;
        jLabel1.setText(wellcomeMsg);
        
        //SQL initialization
        JavaDataBaseConnector createDatabase=new JavaDataBaseConnector();
        createDatabase.getConnect("",password);
        boolean needInit = createDatabase.createTable("CREATE DATABASE "+dbName);
        createDatabase.connenctionClose();
        
        //initialize if databse Shondesh is not exist
        if( needInit==true ){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("prothom alo status");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("naya diganta status");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 741, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 761, Short.MAX_VALUE)
